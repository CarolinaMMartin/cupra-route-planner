...
2. Aplicar, en este orden, únicamente las dos migraciones de esta entrega:
...
usa `rubro`, `rubros_disponibles()` y `guardar_asignaciones()`.
...
- Generar una ruta con inventario suficiente: ocho visitas; mezcla objetivo 5-2-1.
...
- Si no hay candidatos suficientes hasta 15 km, informa el déficit. No amplía sin límite.
