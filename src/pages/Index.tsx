        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-6 lg:px-12">
          <div className="flex justify-between items-center py-5">
            ...
            <div className="flex items-center gap-5">
              ...
              <div className={`h-8 w-px bg-border/50 ${profile.rol === 'vendedor' ? 'hidden md:block' : ''}`} />
              ...
              <Button variant="ghost" size="sm" onClick={handleLogout} className="flex items-center gap-2 text-muted-foreground hover:text-destructive transition-colors">
                ...
                <span className={`text-sm tracking-wide ${profile.rol === 'vendedor' ? 'hidden md:inline' : ''}`}>Salir</span>
              </Button>
            </div>
          </div>
        </div>
